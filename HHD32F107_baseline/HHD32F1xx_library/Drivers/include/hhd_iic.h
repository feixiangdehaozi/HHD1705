...
{
uint32_t DATA:
    8;	//This register holds data values that have been received or are to be transmitted.
...
{
    __IO union IIC_CONSET_REG
        CONSET;                        /*!< IIC control set bit register                                          */
    __IO union IIC_STAT_REG
        STAT;                          /*!< IIC state register                                                    */
    __IO union IIC_DAT_REG
        DAT;                           /*!< IIC data register                                                     */
    __IO union IIC_ADR_REG
        ADR0;                          /*!< IIC Slave Address Register 0                                          */
    __IO union IIC_SCLH_REG
        SCLH;                          /*!< Duty Cycle Register High Half Word                                    */
    __IO union IIC_SCLL_REG
        SCLL;                          /*!< Duty Cycle Register Low Half Word                                     */
    __O  union IIC_CONCLR_REG
        CONCLR;                        /*!< IIC Control Clear Register                                            */
    __I  uint32_t  RSVD;
    __IO union IIC_ADR_REG
        ADR1;                          /*!< IIC Slave Address Register 1                                          */
    __IO union IIC_ADR_REG
        ADR2;                          /*!< IIC slave address register2                                           */
    __IO union IIC_ADR_REG
        ADR3;                          /*!< IIC slave address register3                                           */
    __I  union IIC_DATA_REG
        DATA_BUFFER;                   /*!< IIC data buffer register                                              */
    __IO union IIC_MASK_REG
        MASK0;                         /*!< IIC address mask register0                                            */
    __IO union IIC_MASK_REG
        MASK1;                         /*!< IIC address mask register1                                            */
    __IO union IIC_MASK_REG
        MASK2;                         /*!< IIC address mask register2                                            */
    __IO union IIC_MASK_REG
        MASK3;                         /*!< IIC address mask register3                                            */
} HHD32F1_IIC_TypeDef;
