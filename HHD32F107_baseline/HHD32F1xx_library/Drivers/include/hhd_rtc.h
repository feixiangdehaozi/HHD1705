...
{
    __I  union RTC_DR_REG
        DR;                                /*!< RTC data register                                                     */
    __IO union RTC_MR_REG
        MR;                                /*!< RTC match register                                                    */
    __IO union RTC_LR_REG
        LR;                                /*!< RTC load register                                                     */
    __IO union RTC_CR_REG
        CR;                                /*!< RTC control register                                                  */
    __IO union RTC_ICSC_REG
        ICSC;                              /*!< Interrupt control set/clear register                                  */
    __I  union RTC_RIS_REG
        RIS;                               /*!< Raw interrupt status register                                         */
    __I  union RTC_MIS_REG
        MIS;                               /*!< Masked interrupt status register                                      */
    __O  union RTC_ICR_REG
        ICR;                               /*!< RTC interrupt clear register                                          */
} HHD32F1_RTC_TypeDef;
